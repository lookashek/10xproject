 ...
 */
export interface FlashcardBatchCreateCommand {
 ...
 */
export interface GenerationsViewProps {
 ...
 */
export interface AcceptanceRateIndicatorProps {
 ...
 */
export interface AcceptanceRateViewModel {
 ...
 */
export interface GenerationDetailViewProps {
 ...
 */
export interface GenerationDetailHeaderProps {
  /** Dane generacji */
 ...
 */
export interface GenerationStatsGridProps {
  /** Dane generacji */
  generation: GenerationDetailDTO;
}
 ...
 */
export interface SourceTextSectionProps {
 ...
 */
export interface AssociatedFlashcardsSectionProps {
