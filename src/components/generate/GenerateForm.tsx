...
export function GenerateForm({ onGenerate, isLoading, initialValue = "" }: GenerateFormProps) {
  ...
  return (
    <form data-testid="generate-form" onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        />
        <CharacterCounter current={formState.charCount} min={1000} max={10000} isValid={formState.isValid} />
      ...
      <Button type="submit" disabled={!formState.isValid || isLoading} className="w-full" size="lg">
        {isLoading ? (
          <>
