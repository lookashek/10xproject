...
export function SettingsView({ user }: SettingsViewProps) {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl" data-testid="settings-view">
      {/* Header */}
      ...
      <div className="mb-8 p-4 rounded-lg border bg-card">
        ...
        <div className="space-y-1 text-sm text-muted-foreground">
          ...
          {user.username && (
            <p>
              <span className="font-medium text-foreground">Nazwa użytkownika:</span> {user.username}
            </p>
          )}
        </div>
      </div>
