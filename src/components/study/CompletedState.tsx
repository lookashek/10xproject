        ...
        <Card>
          <CardContent className="p-12 text-center space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl font-bold">Świetna robota!</h1>
              <p className="text-lg text-muted-foreground">Ukończyłeś sesję nauki</p>
            </div>

            {/* Stats */}
            <div className="grid grid-cols-2 gap-4 py-4">
              <div className="space-y-1">
                <div className="text-4xl font-bold">{stats.totalReviewed}</div>
            ...
            <div className="border-t pt-6">
              <h3 className="text-sm font-medium text-muted-foreground mb-4">Twoje oceny</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
              <Button variant="outline" size="lg" onClick={onExit} className="gap-2">
            ...
            {/* Auto-redirect countdown */}
            <p className="text-sm text-muted-foreground">Automatyczne przekierowanie za {countdown}s</p>
          </CardContent>
        </Card>
      </div>
    </div>
