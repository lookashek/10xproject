...
export default function FlashcardGrid({ flashcards, onEditClick, onDeleteClick }: FlashcardGridProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" data-testid="flashcard-grid">
