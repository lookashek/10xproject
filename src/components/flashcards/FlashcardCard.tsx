      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden">
          <div className="h-full p-6 bg-card rounded-lg shadow-md border border-border flex flex-col">
            ...
            <p className="flex-1 text-base text-card-foreground break-words overflow-y-auto">{flashcard.front}</p>
          </div>
        </div>
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="h-full p-6 bg-accent rounded-lg shadow-md border border-border flex flex-col">
            ...
            <p className="flex-1 text-base text-accent-foreground break-words overflow-y-auto">{flashcard.back}</p>
          </div>
        </div>
