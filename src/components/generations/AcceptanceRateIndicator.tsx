        ...
        <TooltipTrigger asChild>
          <div className="flex items-center gap-3">
            <div className="flex-1">
              <Progress value={rate.percentage} className="h-2" indicatorClassName={progressColorClass} />
            </div>
            <span className="text-sm font-medium min-w-[3rem] text-right">{rate.percentage}%</span>
          </div>
        </TooltipTrigger>
        <TooltipContent>
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">Bez edycji: {rate.acceptedUnedited}</p>
            <p className="text-sm text-muted-foreground">Z edycją: {rate.acceptedEdited}</p>
          </div>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
